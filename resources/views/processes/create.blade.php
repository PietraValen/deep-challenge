...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-primary mb-1">Novo Processo</h2>
            <p class="text-muted small mb-0">Cadastre um novo processo jurídico</p>
        </div>
                    ...
                    <form action="{{ route('processes.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                id="title" name="title" value="{{ old('title') }}" placeholder="Ex: Ação de Cobrança"
                                required>
                            @error('title')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    id="court" name="court" value="{{ old('court') }}">
                                @error('court')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    id="value" name="value" value="{{ old('value') }}" placeholder="0,00">
                                @error('value')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
